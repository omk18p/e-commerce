        ...
        {[...Array(30)].map((_, i) => (
          <Box
            ...
            sx={{
              ...
              background: '#A78BFA',
              borderRadius: '50%',
              animation: `signup-twinkle ${2 + Math.random() * 2}s ease-in-out infinite`,
        ...
        {[...Array(10)].map((_, i) => (
          <Box
            ...
            sx={{
              ...
              borderRadius: '50%',
              animation: `signup-sparkle ${4 + Math.random() * 2}s ease-in-out infinite`,
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 100}%`,
        ...
        {[...Array(15)].map((_, i) => (
          <Box
            ...
            sx={{
              ...
              borderRadius: '50%',
              animation: `signup-float ${8 + Math.random() * 4}s ease-in-out infinite`,
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 100}%`,
        ...
        {[...Array(5)].map((_, i) => (
          <Box
            ...
            sx={{
              ...
              borderRadius: '50%',
              animation: `signup-shooting-star ${6 + Math.random() * 3}s linear infinite`,
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 100}%`,
              ...
              '@keyframes signup-shooting-star': {
                '0%': {
